...
from custom_dataset.config import TRADE_START_DATE, TRADE_END_DATE
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_file', default='./contest2023/custom_dataset/train_data.csv', help='Trade data file')
    parser.add_argument('--exp_name', default='exp0')
